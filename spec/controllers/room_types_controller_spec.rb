...
RSpec.describe RoomTypesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new room_type" do

        post :create, params: {room_type: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(room_type_url(RoomType.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new room_type" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the room_type" do
        room_type = RoomType.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the room_type" do
        room_type = RoomType.create! valid_attributes
